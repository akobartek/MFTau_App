...
class MfTauSongBookRepository : SongBookRepository() {
    override val songTitles = arrayOf(
    ...
    override val topics = mapOf(
        Topic.ALL to (1..916).toList(),
        Topic.SAINT_FRANCIS to listOf(
        ...
        Topic.KIDS to (844..872).toList(),
        Topic.CAROLS to (873..916).toList()
    )

    override val songs = arrayOf(
