...
class PresencePagerAdapter(supportFragmentManager: FragmentManager, private val names: Array<String>,
                           private val member: Member) : FragmentPagerAdapter(supportFragmentManager) {
