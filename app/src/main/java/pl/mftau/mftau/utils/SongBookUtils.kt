...
object SongBookUtils {
    ...
    enum class Topics(val value: Int) {
    ...
    val topics = mapOf(
        Topics.ALL to (1..916).toList(),
        Topics.SAINT_FRANCIS to listOf(
        ...
        Topics.KIDS to (844..872).toList(),
        Topics.CAROLS to (873..916).toList()
    )
