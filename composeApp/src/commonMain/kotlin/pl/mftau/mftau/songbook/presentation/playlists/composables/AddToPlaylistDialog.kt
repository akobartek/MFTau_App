...
import mftau.composeapp.generated.resources.add_to_playlist
...
fun AddToPlaylistDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(text = stringResource(Res.string.add_to_playlist), fontFamily = mfTauFont())
        },
        text = {
            Box {
                LazyColumn(
        ...
        confirmButton = {
            TextButton(onClick = { saveSongInPlaylists(selectedPlaylists) }) {
