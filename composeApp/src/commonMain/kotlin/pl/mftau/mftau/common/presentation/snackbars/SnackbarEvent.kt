...
sealed class SnackbarEvent(
    ...
    data object SignedIn :
        SnackbarEvent(message = Res.string.signed_in)

    data object SignInError :
        SnackbarEvent(message = Res.string.sign_in_error)

    data object SignUpError :
        SnackbarEvent(message = Res.string.sign_up_error)

    data object ResetPasswordMessageSent :
        SnackbarEvent(message = Res.string.message_sent)

    data object AccountDeleted :
        SnackbarEvent(message = Res.string.delete_account_success)

    data object CopiedToClipboard :
        SnackbarEvent(message = Res.string.copied_to_clipboard)
    ...
    data object PersonSaved :
        SnackbarEvent(message = Res.string.person_saved)

    data object PersonDeleted :
        SnackbarEvent(message = Res.string.person_delete_success)

    data object EmausDeleteSuccess :
        SnackbarEvent(message = Res.string.draw_delete_success)

    data object EmausDeleteError :
        SnackbarEvent(message = Res.string.draw_delete_error)

    data object MeetingSaved :
        SnackbarEvent(message = Res.string.meeting_saved)

    data object MeetingDeleted :
        SnackbarEvent(message = Res.string.meeting_delete_success)
}